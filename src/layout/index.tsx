        ...
        <div className="min-h-screen bg-[#151515]">
            <nav className="bg-[#151515] p-6 flex justify-between items-center shadow-sm border-b border-yellow-500">
                ...
                <div className="flex space-x-12">
                    ...
                    <Link href="/messages" className="font-medium cursor-pointer text-[#FFDE07] border-b-2 border-transparent hover:border-b-2 hover:border-white">Enviar Mensagem</Link>
                </div>
